...
import com.example.zhou.info.FileInfo;
import com.example.zhou.utils.C;
import com.example.zhou.utils.FileUtils;
import com.example.zhou.widget.WidgetInfo;
...
public class DBUtils
{
    ...
    public ArrayList<String> getWidgetConfigTags() {
        ...
        String[] mainTags = new String[0];//= mContext.getResources().getStringArray(R.array.main_titles);
